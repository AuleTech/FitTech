...
public interface IUserService
{
    ...
    Task<Result> CancelInvitations(string ClientEmail,CancellationToken cancellationToken);
    Task<Result> ResendInvitations(string ClientEmail,CancellationToken cancellationToken);
}
