...
//                 new KeyValuePair<string, string?>($"Authentication:{nameof(AuthenticationSettings.Audience)}",
//                     "testAudience"),
//                 new KeyValuePair<string, string?>($"Authentication:{nameof(AuthenticationSettings.Issuer)}",
//                     "testIssuer"),
//                 new KeyValuePair<string, string?>($"Authentication:{nameof(AuthenticationSettings.SigningKey)}",
//                     "ThisIsALocalKey1234ThisIsALocalKey1234!"),
//                 new KeyValuePair<string, string?>($"SecretsSettings:{nameof(SecretsSettings.EmailFitTech)}",
//                     "admin@fittech.es"),
...
//
//         TestContext.Current!.ObjectBag.Add(TestUserInfo.SharedKey,
//             new TestUserInfo { Email = registerDto.Email, Password = registerDto.Password });
//     }
//
//     [Test]
//     [Timeout(30_000)]
...
//     {
//         var registerAsyncTestContext = TestContext.Current!
//             .GetTests(nameof(RegisterAsync_WhenEmailAndPasswordAreOk_ReturnsSucceeded))
//             .First();
//
...
//     public async Task RefreshTokenAsync_WhenRefreshTokenIsProvided_GeneratesANewAccessToken(
//         CancellationToken cancellationToken)
//     {
//         var registerAsyncTestContext = TestContext.Current!
//             .GetTests(nameof(LoginAsync_WhenEmailAndPasswordAreOk_ReturnAccessToken))
//             .First();
//
//         var userInfo = registerAsyncTestContext.ObjectBag[TestUserInfo.SharedKey] as TestUserInfo;
//
...
//
//         var result = await _sut!.RefreshTokenAsync(new RefreshTokenDto(userInfo!.RefreshToken!, userInfo.AccessToken!),
//             cancellationToken);
//
//         await Assert.That(result.Succeeded).IsTrue();
