...
namespace AuleTech.Core.System.IO.FileSystem.Files
{
	internal partial class SystemIoFileProxy
	{
		...
		private StreamReader AsyncStreamReader(string path) => AsyncStreamReader(path, DefaultUtf8Encoding);
		...
		private StreamWriter AsyncStreamWriter(string path
		                                       , bool append) => AsyncStreamWriter(path, DefaultUtf8Encoding, append);
