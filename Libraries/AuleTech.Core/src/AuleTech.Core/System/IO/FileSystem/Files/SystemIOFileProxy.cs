...
internal sealed partial class SystemIoFileProxy : ISystemIoFileDirect
{
    ...
    public Task<string[]> ReadAllLinesAsync(string filePath
        , CancellationToken cancellationToken = default)
    {
        return ReadAllLinesAsync(filePath, DefaultUtf8Encoding, cancellationToken);
    }
    ...
    {
        return ReadAllText(path, DefaultUtf8Encoding);
    }
    ...
    public Task<string> ReadAllTextAsync(string path
        , CancellationToken cancellationToken = default)
    {
        return ReadAllTextAsync(path, DefaultUtf8Encoding, cancellationToken);
    }
    ...
    public void Copy(string sourceFile
        ...
        , bool overwrite)
    {
        CopyAsync(sourceFile, destinationFile, overwrite)
            .GetAwaiter()
            .GetResult();
    }
    ...
    public Task MoveAsync(string sourceFile
        ...
        , CancellationToken cancellationToken = default)
    {
        return MoveAsync(sourceFile, destinationFile, false, cancellationToken);
    }
    ...
    public FileAttributes GetAttributes(string fileOrFolderPath)
    {
        return File.GetAttributes(fileOrFolderPath);
    }
    ...
    {
        return ResilientOperations.Default.FileSystemRetry(_ => File.GetCreationTimeUtc(filePath));
    }
    ...
    {
        return AsyncWriteFileStream(path, false);
    }
    ...
    {
        return ResilientOperations.Default.FileSystemRetryAsync(async _ =>
            {
    ...
    public Task WriteAllTextAsync(string path
        ...
        , CancellationToken cancellationToken = default)
    {
        return WriteAllTextAsync(path, content, DefaultUtf8Encoding, cancellationToken);
    }
    ...
    public Task ReplaceTokenAsync(string path
        ...
        , CancellationToken cancellationToken)
    {
        return ReplaceTokensAsync(path
