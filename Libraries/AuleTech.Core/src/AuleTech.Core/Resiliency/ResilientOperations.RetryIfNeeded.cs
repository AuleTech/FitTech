	...
	public partial class ResilientOperations
	{
											 ...
											 , CancellationToken cancellationToken = default)
		{
			await RetryIfNeededAsync(async attempt =>
				...
				, waitBetweenAttempts
				, onException
				, customExceptionOnMaxAttemptsWithoutException is not null ? (_) => customExceptionOnMaxAttemptsWithoutException() : null
				, cancellationToken);
		}
		...
		public Task<TResult> RetryIfNeededAsync<TResult>(Func<int, Task<TResult>> payloadAction
														 ...
														 , Func<TResult, Exception>? customExceptionOnMaxAttemptsWithoutException = null
														 , CancellationToken cancellationToken = default) =>
			RetryIfNeededAsync(payloadAction
				, timeout
				, TimeSpan.Zero
				, mustRetry
				, onException
		                                                        ...
		                                                        , CancellationToken cancellationToken = default)
		{
			...
			bool ItTimedOut() => DateTime.UtcNow.Subtract(started) > timeout!.Value;

			bool CanThrowCustomException() => customExceptionOnMaxAttemptsWithoutException is not null;
		}
	}
}
