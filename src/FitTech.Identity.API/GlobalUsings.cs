...
global using FitTech.Identity.API;
global using FitTech.Identity.API.Configuration;
global using FitTech.Identity.API.Data;
global using FitTech.Identity.API.Extensions;
global using FitTech.Identity.API.Models;
global using FitTech.Identity.API.Services;
